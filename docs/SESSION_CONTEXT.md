...
**Tests:** 1075 passing (`mvn test -Dsurefire.useFile=false`) — verified 2026-05-20 after merging main v0.3.1 (+2 country-localization tests vs. the 1073 judging-listeners baseline).
