...
**▶ LATEST (2026-06-05 — dev-seed fast-path to a published entrant scoresheet + verbose all-fields demo entries in each CHIP division; 1340 tests green; fast-path committed `9a3b5e4`, the 3rd-Fast-Track-entry + CHIP-verbose-entries changes NOT yet committed — working tree dirty).**
