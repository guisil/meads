...
**Branch:** `main`
**Tests:** 794 passing (`mvn test -Dsurefire.useFile=false`) — verified 2026-05-17 (Entry primary-category dropdowns now filter to REGISTRATION scope only — no longer showed duplicated codes after judging categories were initialized)
