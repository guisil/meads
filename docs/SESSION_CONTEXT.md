...
**NEXT:** suggest commit(s) for Group A → then **Group B** (re-walk §12.6→§13 to RESULTS_PUBLISHED:
entrant-scoresheet redesign, §13.12 anonymity, P21 stage-gating) → code review → merge → v0.4.0.
