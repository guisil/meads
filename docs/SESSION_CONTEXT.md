...
**Branch:** `main`
**Tests:** 791 passing (`mvn test -Dsurefire.useFile=false`) — verified 2026-05-16 (post-i18n fix for sidebar nav items + entry-edit Final Category label)
