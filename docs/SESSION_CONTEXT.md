...
**Branch:** `main`
**Tests:** 795 passing (`mvn test -Dsurefire.useFile=false`) — verified 2026-05-17 (Final Category picker now shows leaf judging categories only; parent rows that have subcategories are hidden)
