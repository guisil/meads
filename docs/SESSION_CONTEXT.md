...
**Tests:** 1114 passing (`mvn test -Dsurefire.useFile=false`) — verified 2026-05-23 after the `DivisionAdvanceGuard` family, `AwardsService.republish` refactor, and the BOS-places lock moving from REGISTRATION_CLOSED to JUDGING (+16 tests vs. the 1098 audit-fixes baseline).
