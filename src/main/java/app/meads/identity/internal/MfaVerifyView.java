...
@Route("mfa")
@AnonymousAllowed
class MfaVerifyView extends VerticalLayout implements BeforeEnterObserver {
    ...
    MfaVerifyView(UserService userService, UserDetailsService userDetailsService) {
    ...
    private void buildUi() {
        ...
        card.add(codeField, submitButton);
        add(card);
